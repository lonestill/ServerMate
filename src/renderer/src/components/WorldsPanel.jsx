...
import { Globe, Trash2, AlertTriangle, RefreshCw, FolderOpen } from '../Icons'
...
export default function WorldsPanel({ server, isRunning }) {
  ...
  const [deleting, setDeleting] = useState(null) // world name
    ...
    <div className="flex flex-col h-full overflow-y-auto">
      <div className="p-5 max-w-lg flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between">
          <h2 className="text-[14px] font-semibold text-[#ecedee]">Миры</h2>
        ...
        {isRunning && (
          <div className="flex items-start gap-2 p-3 bg-[#f59e0b0d] border border-[#f59e0b25] rounded-xl">
            ...
            <p className="text-[12px] text-[#f59e0b]">Останови сервер перед удалением мира</p>
          </div>
        )}
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center gap-2 py-12">
            ...
            <p className="text-[13px] text-[#55556a]">Миры не найдены</p>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {isActive && (
                        <span className="text-[9px] font-semibold text-[#1bd96a] bg-[#1bd96a15] px-1.5 py-0.5 rounded">активный</span>
                      )}
                    </div>
                  ...
                  {!isConfirming ? (
                    ...
                    <div className="shrink-0 flex items-center gap-2">
                      <span className="text-[11px] text-[#55556a]">Точно?</span>
                      <button
        ...
        <div className="p-3 bg-[#17171c] border border-[#2a2a35] rounded-xl">
          <p className="text-[11px] text-[#55556a] leading-relaxed">
            Активный мир задаётся параметром <span className="font-mono text-[#ecedee]">level-name</span> в Настройках. После удаления мира и перезапуска сервера он создаст новый.
          </p>
        </div>
